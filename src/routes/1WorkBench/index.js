        		...
        		<div className="wrap">
    				<div className="main">
    					<div className="main-inner">
    						...
    						<Alert type="danger" className="mb20" style={{position:"relative"}}>免费试用期还剩 1 天，为不影响营业，请尽快订购哦。咨询电话： 0571-85225188
    							<Button type="primary"  outline >二级按钮</Button>
    						</Alert>

    						<div style={{background:"#f8f8f8"}} className="mb20" >
	    						<Row gutter={16}>
	    						  <Col span={6} ><div className="panel"><span>今日交易额（元）</span><div> <b>0.00</b></div><small>线下：0.00</small></div></Col>
	    						  <Col span={6} ><div className="panel"><span>今日交易额（元）</span><div> <b>0.00</b></div><small>线下：0.00</small></div></Col>
	    						  <Col span={6} ><div className="panel"><span>今日交易额（元）</span><div> <b>0.00</b></div><small>线下：0.00</small></div></Col>
	    						  <Col span={6} ><div className="panel"><span>今日交易额（元）</span><div> <b>0.00</b></div><small>线下：0.00</small></div></Col>
	    						</Row>
    						...
    						<div style={{background:"#f8f8f8"}} className="mb20">
	    						<Row gutter={16}  >
	    						  <Col span={12} >
                                        ...
                                        <div style={{padding:"0 20px 20px"}} >
                                            <div className="todo-item">
                                                <div style={{float:"right"}}><a href="">0个订单</a></div>
                                                <span>外卖订单-带接单</span>
                                            </div>
                                  ...
                                  <Col span={4} style={{textAlign:"center"}} >
                                    ...
                                    <Button type="danger" outline>在线批发</Button>
                                  </Col>
                                  ...
                                  <Col span={4} style={{textAlign:"center"}} >
                                    ...
                                    <div>
                                        <img style={{width:"100px", height:"100px"}} alt="开单收银"/>
                                    </div>
                                  </Col>
	    						</Row>
    						</div>
